...
def plot_closest_objects_all_sky(Object_name, RA_target, DEC_target, RA_closest, DEC_closest, RAoffset, DECoffset, ROToffset):
    ...
    DEC_det = DEC_closest+DECoffset/3600
    RA_det = RA_closest+RAoffset*calc_extend_ratio(np.abs(RAoffset),DEC_det)/3600
    ...
    if (RAoffset, DECoffset, ROToffset) == (0, 0, 0):
        FieldName = Object_name
    else:
        FieldName = Object_name+f' (RAoffset["], DECoffset["], ROToffset[°])=({RAoffset}, {DECoffset}, {ROToffset})'
...
def plot_closest_objects_bulge(Object_name, RA_target, DEC_target, RA_closest, DEC_closest, RAoffset, DECoffset, rot, ROToffset):
    RAoffset = int(RAoffset)
    DECoffset = int(DECoffset)
    ROToffset = int(ROToffset)
...
def plot_closest_objects_nogrid(Object_name, RA_target, DEC_target, RAoffset, DECoffset, ROToffset):
    RAoffset = int(RAoffset)
    DECoffset = int(DECoffset)
    ROToffset = int(ROToffset)
    ...
    if (RAoffset, DECoffset, ROToffset) == (0, 0, 0):
        ...
        FieldName = 'FOV'+f' (RAoffset["], DECoffset["], ROToffset[°])=({RAoffset}, {DECoffset}, {ROToffset})'
